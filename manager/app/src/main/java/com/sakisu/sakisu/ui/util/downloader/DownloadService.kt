...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.sakisu.sakisu.action.DOWNLOAD"
        const val ACTION_CANCEL = "com.sakisu.sakisu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.sakisu.sakisu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.sakisu.sakisu.action.INSTALL_MODULE"
